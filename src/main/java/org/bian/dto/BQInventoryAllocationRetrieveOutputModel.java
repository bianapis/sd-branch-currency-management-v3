...
import org.bian.dto.BQInventoryAllocationRetrieveOutputModelInventoryAllocationInstanceAnalysis;
import org.bian.dto.BQInventoryAllocationRetrieveOutputModelInventoryAllocationInstanceReport;

import javax.validation.Valid;
  
/**
 * BQInventoryAllocationRetrieveOutputModel
 */
public class BQInventoryAllocationRetrieveOutputModel   {
  ...
  private String inventoryAllocationRetrieveActionTaskReference = null;

  private Object inventoryAllocationRetrieveActionTaskRecord = null;

  private String inventoryAllocationRetrieveActionResponse = null;

  private BQInventoryAllocationRetrieveOutputModelInventoryAllocationInstanceReport inventoryAllocationInstanceReport = null;

  private BQInventoryAllocationRetrieveOutputModelInventoryAllocationInstanceAnalysis inventoryAllocationInstanceAnalysis = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Inventory Allocation instance retrieve service call 
   * @return inventoryAllocationRetrieveActionTaskReference
  **/

  public String getInventoryAllocationRetrieveActionTaskReference() {
    return inventoryAllocationRetrieveActionTaskReference;
  }

  public void setInventoryAllocationRetrieveActionTaskReference(String inventoryAllocationRetrieveActionTaskReference) {
    this.inventoryAllocationRetrieveActionTaskReference = inventoryAllocationRetrieveActionTaskReference;
  }
  ...
  **/
   ...
   * @return inventoryAllocationRetrieveActionResponse
  **/

  public String getInventoryAllocationRetrieveActionResponse() {
    return inventoryAllocationRetrieveActionResponse;
  }

  public void setInventoryAllocationRetrieveActionResponse(String inventoryAllocationRetrieveActionResponse) {
    this.inventoryAllocationRetrieveActionResponse = inventoryAllocationRetrieveActionResponse;
  }
  ...
  **/
  ...
  public BQInventoryAllocationRetrieveOutputModelInventoryAllocationInstanceReport getInventoryAllocationInstanceReport() {
    return inventoryAllocationInstanceReport;
  }

  public void setInventoryAllocationInstanceReport(BQInventoryAllocationRetrieveOutputModelInventoryAllocationInstanceReport inventoryAllocationInstanceReport) {
  ...
  **/
  ...
  public BQInventoryAllocationRetrieveOutputModelInventoryAllocationInstanceAnalysis getInventoryAllocationInstanceAnalysis() {
    return inventoryAllocationInstanceAnalysis;
  }

  public void setInventoryAllocationInstanceAnalysis(BQInventoryAllocationRetrieveOutputModelInventoryAllocationInstanceAnalysis inventoryAllocationInstanceAnalysis) {
